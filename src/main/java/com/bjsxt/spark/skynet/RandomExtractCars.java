...
public class RandomExtractCars {
	...
	private static JavaPairRDD<String, Row> randomExtractCarInfo(
		...
		/**
		 * key:时间段   value：car
		 * dateHourCar2DetailRDD ---- ("dateHour"="2018-12-01_08","car"="京X91427")
		 */
		JavaPairRDD<String, String> dateHourCar2DetailRDD = cameraRDD.mapToPair(new PairFunction<Row, String,String>() {
			...
			public Tuple2<String, String> call(Row row) throws Exception {
				String actionTime = row.getAs("action_time");//2019-03-24 06:18:49
				String dateHour = DateUtils.getDateHour(actionTime);//2019-03-24_06
				...
				//(dateHour=2018-12-26_18 , car=鲁xxxxx)
		...
		for (Entry<String, Long> entry : countByKey.entrySet()) {
			String dateHour = entry.getKey();//2019-03-25_20
			String[] dateHourSplit = dateHour.split("_");
			String date = dateHourSplit[0];//2019-03-25
			String hour = dateHourSplit[1];//20
			//本日期时段对应的车辆数
		...
		//dateHourCountMap ---- Map<date,Map<hour,carCount>>
