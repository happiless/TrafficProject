...
//     	String[] areas = new String[]{"海淀区","朝阳区","昌平区","东城区","西城区","丰台区","顺义区","大兴区"};
    	...
    	for (int i = 0; i < 3000; i++) {
        	...
        	String baseActionTime = date + " " + StringUtils.fulfuill(random.nextInt(24)+"");//2019-03-21 08
        	/**
        	...
        	for(int j = 0 ; j < (random.nextInt(300)+1) ; j++){
        		...
        		String actionTime = baseActionTime + ":" 
        				...
        				+ StringUtils.fulfuill(random.nextInt(60)+"");//模拟经过此卡扣开始时间 ，如：2019-03-21 08:10:20
...
//    	monitorDF.registerTempTable("monitor_camera_info");
	...
	public static void main(String[] args) {
		SparkSession session = SparkSession.builder().master("local").appName("mockData").getOrCreate();
